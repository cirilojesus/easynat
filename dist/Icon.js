...
const Icon = (_a) => {
    var _b;
    var { name, as = "MaterialIcons", // por defecto
    size = 20, color = "text" } = _a, props = __rest(_a, ["name", "as", "size", "color"]);
    ...
    return (<IconComponent name={name} size={size} color={((_b = theme.colors) === null || _b === void 0 ? void 0 : _b[color]) || color} style={styles}/>);
};
exports.Icon = Icon;
