...
function DatePicker(_a) {
    ...
    var { locale = "en-US", colorScheme = "primary", type = "calendar", unSelect = false, separate = "-", icon = true } = _a, props = __rest(_a, ["locale", "colorScheme", "type", "unSelect", "separate", "icon"]);
    ...
    const { label, _label, isRequired, value, placeholder, onChange, _months, _weekdays, _years, _days, _time, _buttonCancel, _buttonDone, config, minValue, maxValue, _icon } = Object.assign(Object.assign({}, styles_default), props);
