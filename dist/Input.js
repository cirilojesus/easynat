...
const InputText = (_a) => {
    ...
    return (<>
            ...
            setFocus(false);
                ...
                {combinedProps.isPassword && (<Button_1.Button onPress={() => setShowPassword(!showPassword)} variant={'ghost'} rounded={40} p={1} mr={2} marginVertical={4.5}>
                        {showPassword ? <Icon_1.Icon name="eye-off" as={'Feather'}/> : <Icon_1.Icon name="eye" as={'Feather'}/>}
                    </Button_1.Button>)}
            </Box_1.Box>
        </>);
};
