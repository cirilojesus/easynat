...
exports.Modal = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (<react_native_root_siblings_1.RootSiblingPortal>
            ...
            ...backdropStyle,
            {
                ...
                <KeyboardAvoidingView_1.KeyboardAvoiding {...props}>
            ...
            ...contentStyle,
                        ...
                        {combinedProps.iconClose === true ? (<Button_1.Button variant="ghost" position="absolute" zIndex={100} rounded={50} right={0} m={2} children={<Icon_1.Icon name="close" as="AntDesign" {...(_d = combinedProps._icon) === null || _d === void 0 ? void 0 : _d.icon}/>} onPress={close} {...combinedProps._icon}/>) : (combinedProps.iconClose && combinedProps.iconClose(Object.assign({ onPress: close }, combinedProps._icon)))}
                        {combinedProps.children}
                    </react_native_1.Animated.View>
                </KeyboardAvoidingView_1.KeyboardAvoiding>
                <Box_1.Box bg={combinedProps.bg || 'white'} safeAreaBottom={(combinedProps === null || combinedProps === void 0 ? void 0 : combinedProps.safeAreaBottom) !== undefined ? combinedProps === null || combinedProps === void 0 ? void 0 : combinedProps.safeAreaBottom : true}/>
            </Box_1.Box>
