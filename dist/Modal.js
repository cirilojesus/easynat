...
import { Animated, BackHandler, Easing, StyleSheet, Pressable, Platform } from "react-native";
...
export const Modal = forwardRef(({ ...props }, ref) => {
    ...
    return (<RootSiblingPortal>
            ...
            ...contentStyle,
                        ...
                        {combinedProps.header && (<Box px={5} pb={4} pt={2} borderBottomWidth={1} borderBottomColor="light" {...combinedProps.header}/>)}
                        {combinedProps.iconClose === true ? (<Button variant="ghost" position="absolute" zIndex={100} rounded={50} right={0} m={2} icon={<Icon name="close" as="AntDesign" {...combinedProps._icon?.icon}/>} onPress={close} {...combinedProps._icon}/>) : (combinedProps.iconClose && React.cloneElement(combinedProps.iconClose, { onPress: close, ...combinedProps._icon }))}
