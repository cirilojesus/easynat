...
function renderNode(node) {
    ...
    switch (node.name) {
        ...
        case "input":
            return (<Box_1.Box key={key} borderWidth={1} rounded={5} px={1} mr={1} _text={{ color: "white", fontWeight: "bold" }} bg={((_k = node.attrs) === null || _k === void 0 ? void 0 : _k.checked) == '' ? 'primary.100' : "transparent"}>
                    ✓
                </Box_1.Box>);
        case "br":
